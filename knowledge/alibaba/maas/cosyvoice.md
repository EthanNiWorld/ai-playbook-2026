...
| 维度 | CosyVoice v3.5-plus | OpenAI gpt-4o-tts | ElevenLabs v3 | MiniMax speech-2.8-hd |
|------|---------------------|-------------------|---------------|------------------------|
| 声音复刻 | ✅ | ❌ | ✅ | ✅ 10s 即可复刻 |
| 声音设计 | ✅ | ❌ | ❌ | ❌ |
| 指令控制 | ✅ 自然语言控制 | ❌ | 有限 | 有限 情绪/语速/语气标签 |
| 流式延迟 | 150ms | [⚠️ 待补充] | [⚠️ 待补充] | <300ms TTFB |
| 方言覆盖 | 18 种中文方言 | 有限 | 有限 | 无专项方言支持 |
| 原生语气词 | ❌ | ❌ | ❌ | ✅ 原生建模“嗯”“呃”等 |
| 语言覆盖 | 11 种外语 + 中文方言 | 有限 | 29 种语言 | 40+ 种语言 |
| 开源 | ✅ GitHub | ❌ | ❌ | ❌ |
