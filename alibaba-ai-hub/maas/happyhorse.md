...
|------|--------|-----------|--------------------|------|
| 1.1 T2V/I2V 480P | $0.07/秒 | $0.042/秒 | $0.21 | [官方定价页](https://www.alibabacloud.com/help/en/model-studio/model-pricing) |
| 1.1 T2V/I2V 720P | $0.14/秒 | $0.084/秒 | $0.42 | 同上 |
...
> 计费公式：总费用 = 生成数量 × 视频时长(秒) × 单价。失败不收费。限时折扣截止日期以控制台为准（480P 折后价按 1.1 系列统一 6 折推算，以控制台为准）。
...
| **AA 盲测历史双冠** | 2026 年 4-6 月口径：T2V Elo 1357 / I2V Elo 1415 双榜 #1；2026-08-14 核实 T2V（With Audio）榜 1.1 已回落至 #5（Elo 1147），前四为 Gemini Omni Flash（1241）/ MiniMax H3（1238）/ Seedance 2.0（1222）/ Wan2.7-260612（1159）；2026-09-02 复核：Wan 3.0（Elo 1242）上榜进入前二，反超 Wan2.7 与 HappyHorse（#1/#2 归属两源冲突待复核：AA 官方 snippet 称 Wan 3.0 领先，第三方 invideo 称 Gemini Omni Flash 1245 第一）[来源: Artificial Analysis] |
...
| 音频场景 | 略逊 Seedance 2.0 / MiniMax H3 | AA T2V 带音频榜 #5（2026-08-14 核实；2026-09-02 复核 Wan 3.0 已上榜反超，1.1 最新名次待复核）[来源: Artificial Analysis] |
...
| 纯视觉短视频 | T2V | AA T2V 曾登顶（2026-04~06），2026-08 起 #5，画面质量仍属第一梯队 |
...
| AA T2V Elo（2026-09-02 复核） | 1.1 #5（1147）/ 1.0 #6（1126），曾双榜 #1 | Wan 3.0 进前二（1242，#1/#2 待复核）；Wan2.7-260612 #4（1159） | #3（1222） |
...
| 日期 | 变更内容 |
|------|----------|
| 2026-09-02 | 校验修复（knowledge-verifier 2026-09-02 报告）：AA 榜补记 Wan 3.0（Elo 1242）上榜进前二、反超 Wan2.7/HappyHorse（#1/#2 两源口径冲突待复核）；定价表补 1.1 480P $0.07/秒（折后按统一 6 折推算） |
