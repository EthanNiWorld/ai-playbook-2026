...
> 定价标准：阿里云国际站新加坡节点，2026-09-17 核实（全系限时折扣已结束，恢复纯列表价）

| 规格 | 列表价 | 限时折扣 | 5秒视频成本（列表价） | 来源 |
|------|--------|----------|---------------------|------|
| 1.1 T2V/I2V 480P | $0.07/秒 | —（折扣已结束，2026-09-17 核实） | $0.35 | [官方定价页](https://www.alibabacloud.com/help/en/model-studio/model-pricing) |
| 1.1 T2V/I2V 720P | $0.14/秒 | —（同上） | $0.70 | 同上 |
| 1.1 T2V/I2V 1080P | $0.18/秒 | —（同上） | $0.90 | 同上 |
| 1.0 T2V/I2V 720P | $0.14/秒 | —（同上） | $0.70 | 同上 |
| 1.0 T2V/I2V 1080P | $0.24/秒 | —（同上） | $1.20 | 同上 |

> 计费公式：总费用 = 生成数量 × 视频时长(秒) × 单价。失败不收费。HappyHorse 全系限时折扣（1.1 六折 / 1.0 八折）已于 2026-09 上旬结束，2026-09-17 定价页核实恢复纯列表价。
> 💡 1.1 不仅能力升级，1080P 列表价还从 1.0 的 $0.24/秒降至 $0.18/秒，性价比显著优于 1.0。
...
| **AA 盲测历史双冠** | 2026 年 4-6 月口径：T2V Elo 1357 / I2V Elo 1415 双榜 #1；2026-09-17 核实：T2V With Audio 榜 1.1 降至 #8（Elo 1147）、1.0 #9（1119），前三为 Gemini Omni Flash（1233）/ Wan 3.0（1229）/ Minimax H3 Max（fal，1227）；T2V 无音频榜 1.1 #5（1272）、1.0 #4（1287），榜首 Wan 3.0（1336）；新晋竞品 MAGI-2 Preview / HiDream-O1-Video / Minimax H3 Max [来源: Artificial Analysis] |
...
| 音频场景 | 略逊 Seedance 2.0 / MiniMax H3 | AA T2V 带音频榜 #8（2026-09-17 核实，Wan 3.0 / Minimax H3 Max 等新模型上榜后名次下滑）[来源: Artificial Analysis] |
...
| 场景 | 推荐模型 | 说明 |
|------|----------|------|
| 电商商品展示 | I2V | 静态商品图转动图（AA I2V 带音频榜曾 #1，2026-09-17 核实降至 #7） |
| 纯视觉短视频 | T2V | AA T2V 曾登顶（2026-04~06），2026-09 降至 #8（带音频榜），画面质量仍属第一梯队 |
| 多语言营销 | T2V | 7语言口型同步，一条素材覆盖多市场 |
| 批量素材生产 | T2V 720P | 5秒约 $0.70/条（列表价，新加坡节点），成本可精确预估 |
| 创作者快速迭代 | 千问App | 快速体验 |
...
| 千问 App | 首页 HappyHorse 胶囊入口 | 个人体验 |
...
| AA T2V Elo（2026-09-17 核实，带音频榜） | 1.1 #8（1147）/ 1.0 #9（1119），曾双榜 #1 | Wan 3.0 #2（1229，无音频榜 #1 1336）；Wan2.7-260612 #7（1149） | #5（1210） |
| AA I2V Elo（2026-09-17 核实，带音频榜） | 1.1 #7（1106）/ 1.0 #10（1083），曾 #1 1415 | Wan 3.0 #6（1164，无音频榜 #2 1361） | #5（1174） |
| 音频 | 单次联合生成 | 需外部模型 | 双分支+Cross-Attention |
| 开源 | ❌ coming soon | ✅ Apache 2.0 | ❌ |
| 百炼定价（新加坡） | 1.1 720P $0.14/s（列表价，限时折扣已于 2026-09 结束） | 按量付费 | 火山引擎 ¥~1.0/s |
| LoRA | 宣称支持，不可实操 | ✅ 官方指南 | ❌ |
...
| 日期 | 变更内容 |
|------|----------|
| 2026-09-20 | 移除千问 App 入口的「免费额度 / 免费体验额度」营销信息（用户规范：材料不再考虑免费额度） |
| 2026-09-17 | 校验修复（knowledge-verification-2026-09-17）：全系限时折扣已结束（1.1 六折/1.0 八折标签消失），定价表恢复列表价口径，5 秒成本重算（720P $0.42→$0.70）；AA 榜单全面更新——T2V 带音频 1.1 #8（1147）/ I2V 带音频 1.1 #7（1106）/ T2V 无音频 1.1 #5（1272），解除全部"待复核"标注；补记新晋竞品 MAGI-2 Preview / HiDream-O1-Video / Minimax H3 Max |
