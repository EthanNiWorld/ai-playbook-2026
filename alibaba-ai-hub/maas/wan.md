...
| 音频 | 需外部模型 | 音视频联合单次生成 |
| AA 盲测（2026-09-02 复核） | Wan 3.0 已上榜进前二（Elo 1242，#1/#2 口径冲突待复核）；Wan2.7-260612 T2V（With Audio）#4（Elo 1159） | 曾双冠；1.1 #5（1147） |
...
| 日期 | 变更内容 |
|------|----------|
| 2026-09-02 | 校验修复（knowledge-verifier 2026-09-02 报告）：解除 wan3.0-video 国际站"待确认"——新加坡定价公布（video 480P $0.05/720P $0.10/1080P $0.20 限时 7 折；prime $0.068/$0.14/$0.28）+ 计费规则（输入+输出均按秒计费，免费额度 30 秒）；主推表新增 Wan3.0-Video 🚩 行；AA 榜补记 Wan 3.0（Elo 1242）进前二（#1/#2 待复核） |
