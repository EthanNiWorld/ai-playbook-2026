...
**当前主推**: Wan3.0-Video（新一代旗舰，All-in-One，2026-08-06 上线，国际站已定价）+ Wan2.7 视频系列（Wan2.7-T2V / Wan2.7-I2V / Wan2.7-R2V / Wan2.7-VideoEdit），Wan2.6 仍可用
...
| 模型 | 定位 | 新增能力 | 特点 |
|------|------|------|------|
| 🚩 **Wan3.0-Video** | 新一代旗舰（All-in-One） | 统一文生视频/图生视频（首帧/首尾帧）/参考生视频，最长 30 秒 | 2026-08-06 上线；国际站（新加坡）480P $0.05 / 720P $0.10 / 1080P $0.20（列表价，限时 7 折）；输入+输出视频均按秒计费；另有 wan3.0-video-prime（480P $0.068 / 720P $0.14 / 1080P $0.28） |
...
>
> 📌 **新一代上线**：wan3.0-video 已于 2026-08-06 上线百炼（All-in-One：统一文生视频/图生视频（首帧/首尾帧）/参考生视频，最长可生成 30 秒视频）；国际站（新加坡）已上线并公布定价：wan3.0-video 480P $0.05 / 720P $0.10 / 1080P $0.20（列表价，限时 7 折），wan3.0-video-prime 480P $0.068 / 720P $0.14 / 1080P $0.28；计费规则与 Wan2.7 不同——**输入+输出视频均按秒计费**（Wan2.7 仅输出计费）[来源: help.aliyun.com 上新页 2026-08-14 + 国际站定价页 2026-09-02 核实]
...
| 音频 | 需外部模型 | 音视频联合单次生成 |
| AA 盲测（2026-09-17 核实） | Wan 3.0 T2V 无音频榜 #1（Elo 1336）/ 带音频榜 #2（1229），I2V 无音频榜 #2（1361）；Wan2.7-260612 T2V 带音频榜降至 #7（1149） | 曾双冠；1.1 T2V 带音频榜 #8（1147）、无音频榜 #5（1272） |
| 开源 | ✅ 权重已发布 | ❌ coming soon |
| 百炼商用 | ✅ 新加坡 720P $0.10/s、1080P $0.15/s | ✅ 1.1 720P $0.14/s、1080P $0.18/s（列表价，限时折扣已于 2026-09 结束） |
...
| 日期 | 变更内容 |
|------|----------|
| 2026-09-20 | 移除 wan3.0-video 行「免费额度 30 秒」信息（用户规范：材料不再考虑免费额度） |
| 2026-09-17 | 校验修复（knowledge-verification-2026-09-17）：竞品表 HappyHorse 移除"限时 6 折"（折扣已结束）；AA 行重写——Wan 3.0 T2V 无音频榜 #1（Elo 1336）/ 带音频榜 #2（1229）、I2V 无音频榜 #2（1361），解除"#1/#2 待复核"；Wan2.7-260612 带音频榜降至 #7（1149）；HappyHorse-1.1 带音频榜 #8（1147） |
