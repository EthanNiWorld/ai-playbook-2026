...
> 产品类别: AI App
> 状态: Published
> 产品状态: ⚠️ **产品已下架**（2026-09 `[来源: 用户口述]`），能力由千问办公（QwenWork）承接 → [qwen-work.md](qwen-work.md)

<!-- SUMMARY_START -->
**定位**: 桌面端通用智能体助手（⚠️ 已下架，由 [QwenWork](qwen-work.md) 承接），Qoder IDE 生态衍生产品，将 Agent 能力从代码领域扩展到日常工作场景
...
| 日期 | 变更内容 |
|------|----------|
| 2026-09-17 | 标注产品已下架（用户口述，待官方验证）；能力由 QwenWork（千问办公）承接，新增关联链接 |
